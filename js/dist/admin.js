...
flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('sycho/flarum-private-facade', function (app) {
  app.extensionData["for"]('sycho-private-facade').registerSetting({
    ...
    var useWelcomeBannerValue = this.setting('sycho-private-facade.use_welcome_hero_text')();
    console.log(typeof useWelcomeBannerValue, useWelcomeBannerValue); // @ts-ignore

    var useWelcomeBanner = useWelcomeBannerValue === true || useWelcomeBannerValue === '1';
    return m("div", {
    ...
    }, app.translator.trans('sycho-private-facade.admin.settings.illustration_path')), m(_components_UploadImageButton__WEBPACK_IMPORTED_MODULE_1__["default"], {
